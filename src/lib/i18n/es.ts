...
export const es: Translations = {
    ...
    nav: {
        ...
        theme_auto_hint: 'Doble clic para restaurar el tema automático día/noche',
    ...
    hero: {
        ...
        education: '7.º semestre de Ingeniería de Software en la Universidad de Cartagena.',
    ...
    projects: {
        ...
        screenshot_alt: '{title} — captura {n}',
    },
    skills: {
