...
Índice de la carpeta `docs/`. Punto de entrada del repositorio: [README.md](../README.md).

## Diseño y arquitectura

| Documento | Descripción |
| --------- | ----------- |
| [DESIGN.md](DESIGN.md) | Sistema visual: tokens, tipografía, liquid glass, temas, motion |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Estructura Next.js, i18n, GSAP, flujo de datos |
| [I18N.md](I18N.md) | Guía de internacionalización (ES / EN, banner de sugerencia, default EN) |
| [CONTRIBUTING.md](CONTRIBUTING.md) | Scripts, convenciones y checklist de contribución |

## Agentes IA

| Documento | Descripción |
| --------- | ----------- |
| [../AGENTS.md](../AGENTS.md) | Reglas para agentes de código (Cursor, Claude) |
| [../CLAUDE.md](../CLAUDE.md) | Referencia a AGENTS.md |
